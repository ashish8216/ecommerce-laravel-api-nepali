...
Route::get('/quotation-request', 'QuotationController@quotation')->name('quotation.request');
Route::post('/quotation-request/store', 'QuotationController@quotation_request')->name('post.quotation_request');

Route::post('/custom-order/store', 'CustomOrderController@custom_request')->name('custom_order_request');
...
Route::get('/index_new', 'HomeController@index_new')->name('home.new');
Route::get('/company_profile', 'HomeController@company_profile')->name('home.profile');
Route::get('/company_product', 'HomeController@company_product')->name('home.product');
Route::get('/company_about', 'HomeController@company_about')->name('home.about');
Route::get('/company_contact', 'HomeController@company_contact')->name('home.contact');
...
Route::post('/products/add-more-choice-option', 'ProductController@add_more_choice_option')->name('products.add-more-choice-option');
    ...
    Route::get('custom_orders', 'OrderController@seller_custom_orders')->name('custom_orders');
    Route::get('/custom_orders/destroy/{id}', 'OrderController@destroy')->name('custom_orders.destroy');
    Route::post('/custom_orders/details', 'OrderController@custom_order_details')->name('custom_orders.details');
