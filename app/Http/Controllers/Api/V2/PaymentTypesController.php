        ...
        if($mode != 'wallet') {
            ...
            if ( get_setting('cash_payment' == 1)) {
             ...
             if ( get_setting('esewa_payment' == 1)) {
                ...
                $payment_type['payment_type_key'] = 'MTopPiI7JEU8PSM3MjIgSzUvMVMpIyVJJTVUICBIIyg/IiYxKg==';
                $payment_type['payment_type_secret'] = 'BhwIWRUaBwwaDRxLBAUYRQAKAAQE';
                $payment_type['image'] = url('assets/esewa_logo.png');
                $payment_type['name'] = "Esewa Payment";
