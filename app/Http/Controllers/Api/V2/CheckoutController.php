...
class CheckoutController
{
    ...
    {
          if($request->cart_id){
         $cart_items = Cart::where('user_id', $request->user_id)->where('id',$request->cart_id)->where('owner_id',$request->owner_id)->get();
        }else{
      ...
      if($request->cart_id){
        Cart::where('user_id', $request->user_id)->where('id',$request->cart_id)->where('owner_id',$request->owner_id)->update([
