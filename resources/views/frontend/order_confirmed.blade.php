...
@section('content')
    @php
        $childOrders = $order->childOrder;
        if($childOrders->isNotEmpty()){
            // foreach($childOrders as $k=>$v){
                $status = $childOrders[0]->orderDetails[0]->delivery_status;
            // }
        }else{
                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            @else
                                                ...
                                                <tr>
                                                    <td>#{{$k+1}}: {{$v->code}}</td>
                                                    <td>{{ $v->orderDetails[0]->delivery_status }}</td>
                                                </tr>
                                                @endforeach
                                            @endif
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($childOrders->isNotEmpty())
                                                        @foreach($childOrders as $k=>$v)
                                                            @php 
                                                            //Note Check for way to chenge delivery status. In backend  we have Pending,Confirmed,Picked Up, On the way,Delivered
                                                            // $order->orderDetails->first()->delivery_status;
                                                    ...
                                                    @else
                                                        ...
                                                        @endphp
                                                    @endif
                                                    {{ single_price($totalPrice + $totalTax) }}
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div>
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            @if($childOrders->isNotEmpty())
                                                    {{-- @php 
                                                        $totalShipping = $childOrders[0]->orderDetails->sum('shipping_cost');
                                                       
                                                       
                                                    @endphp --}}
                                                @foreach($childOrders as $k=>$v)
                                                    
                                                    <tr><td>Package #{{$k+1}}</td></tr>
                                        ...
                                        <table class="table ">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <span class="fw-600">{{ single_price($totalPrice) }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <span class="font-italic">{{ single_price($totalShipping) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>{{ translate('Tax')}}</th>
                                                    <td class="text-right">
                                                        <span class="font-italic">{{ single_price($totalTax) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
