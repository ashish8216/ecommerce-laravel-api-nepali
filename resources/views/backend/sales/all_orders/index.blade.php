        ...
        <table class="table aiz-table mb-0">
            ...
            <tbody>
                ...
                @php 
                    ...
                    $orderCount = 0;
                    $details = [];
                    if(!empty($order->childOrder)){
                    if($childOrder->isNotEmpty()){
                        foreach ($childOrder as $k => $v) {
                            $orderCount += count($v->orderDetails);
                            array_push($details,$v);
                        }
                    }else{
                        $orderCount = count($order->orderDetails);
                        array_push($details,$order);
                    }
